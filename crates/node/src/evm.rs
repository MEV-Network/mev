//! # MEV EVM configuration
//!
//! The [`MEVEvmConfig`] type implements the [`ConfigureEvm`] and [`ConfigureEvmEnv`] traits,
//! configuring the custom MEV precompiles and instructions.
//!
...
#[derive(Debug, Clone)]
pub struct MEVEvmConfig {
    chain_spec: Arc<OpChainSpec>,
}

impl MEVEvmConfig {
    /// Creates a new MEV EVM configuration with the given chain spec.
...
impl ConfigureEvmEnv for MEVEvmConfig {
    type Header = Header;
...
impl ConfigureEvm for MEVEvmConfig {
...
mod tests {
    ...
    fn test_fill_cfg_and_block_env() {
        ...
        MEVEvmConfig::new(chain_spec.clone()).fill_cfg_and_block_env(
            &mut cfg_env,
            &mut block_env,
            &header,
            total_difficulty,
