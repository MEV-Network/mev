...
use mev_wallet::{AlloyUpstream, MEVWallet, MEVWalletApiServer};
use reth_tracing::Tracer;
use std::net::{IpAddr, Ipv4Addr};
use tracing::info;
use url::Url;

/// The MEV relayer service sponsors transactions for EIP-7702 accounts.
#[derive(Debug, Parser)]
...
impl Args {
    ...
    async fn run(self) -> eyre::Result<()> {
        ...
        let rpc = MEVWallet::new(AlloyUpstream::new(provider), chain_id).into_rpc();
